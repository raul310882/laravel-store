    ...
    <AuthenticatedLayout title="Wallet">
        <div class="flex flex-col justify-between space-x-0 px-4 py-12 sm:px-6 md:flex-row md:space-x-10 lg:px-8">
            ...
            <div class="w-full space-y-4">
                <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200 md:leading-[64px]">Wallet</h2>
                <div class="bg-white p-4 shadow dark:bg-gray-800 sm:rounded-lg sm:p-8">
                    <credit-card v-if="card" :labels="card" :isNumberMasked="true" :randomBackgrounds="true" />
                    <div
                        :class="['flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0', { 'mt-10': card }]"
                    >
                    ...
                    <modal :show="cardModal" @close="cardModal = false">
                        <div class="p-6">
                            <div class="flex items-center justify-between border-b border-gray-200 pb-2 dark:border-gray-700">
                                ...
                                <button class="text-purple-900 hover:opacity-70 dark:text-purple-200" @click="cardModal = false">
                            ...
                            <div class="mt-6">
                                <div class="flex flex-col">
                                    ...
                                    <primary-button class="mt-4" :disabled="paymentProcessing || !completed" @click="submit">
                                        <font-awesome-icon :icon="['fas', 'credit-card']" />
                    ...
                    <modal :show="confirmingCardDeletion" @close="closeDeletionModal">
                        <div class="p-6">
                            ...
                            <template v-if="hasSocials">
                                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                    Please enter <span class="font-bold italic">confirm delete</span> to confirm you would like to
                                    permanently delete your credit card.
                                </p>
                            ...
                            <template v-else>
                                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                    Please enter your password to confirm you would like to permanently delete your credit card.
                                </p>
